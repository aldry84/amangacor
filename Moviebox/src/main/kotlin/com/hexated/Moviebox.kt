...
override suspend fun load(url: String): LoadResponse {
    ...
    // Use updated score API (Double?), parse imdbRatingValue to Double
    val score: Double? = subject?.imdbRatingValue?.toDoubleOrNull()
    ...
    return if (tvType == TvType.TvSeries) {
        ...
        newTvSeriesLoadResponse(title, url, TvType.TvSeries, episode) {
            ...
            this.tags = tags
            // set score instead of deprecated rating
            this.score = score
            this.actors = actors
